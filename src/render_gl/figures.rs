...
pub fn cube() -> Mesh {
    let vertices = vec![
        -0.5,  0.5, -0.5,  0.9, 0.4, 0.7,  0.0, 0.0,
         0.5,  0.5, -0.5,  1.0, 0.4, 0.6,  0.0, 0.0,
         0.5, -0.5, -0.5,  0.9, 0.4, 0.7,  0.0, 0.0,
        -0.5, -0.5, -0.5,  0.8, 0.4, 0.8,  0.0, 0.0,

        -0.5,  0.5,  0.5,  0.7, 0.4, 0.9,  0.0, 0.0,
         0.5,  0.5,  0.5,  0.8, 0.4, 0.8,  0.0, 0.0,
         0.5, -0.5,  0.5,  0.7, 0.4, 0.9,  0.0, 0.0,
        -0.5, -0.5,  0.5,  0.6, 0.4, 1.0,  0.0, 0.0,
    ];
    let indices: Vec<u16> = vec![
        0, 1, 2,
        0, 2, 3,
